...
func ConvertRange(tagRange *entity.Range, preVal, raw *decimal.Decimal) (newValue, rawValue *float64, invalidType string, isSave bool) {
	if raw == nil {
		return
	}
	value, _ := raw.Float64()
	...
	if tagRange.MinValue == nil || tagRange.MaxValue == nil {
		...
		case entity.RangeMethod_Valid:
			newValue, rawValue, isSave = convertConditions(tagRange, preVal, raw)
			return
		case entity.RangeMethod_Invalid:
			return convertInvalidConditions(tagRange, preVal, raw)
		default:
			newValue = &value
			return
		}
...
func convertInvalidConditions(tagRange *entity.Range, preVal, raw *decimal.Decimal) (newValue, invalidValue *float64, invalidType string, isSave bool) {
	if raw == nil {
		return
	}
	isSave = true
